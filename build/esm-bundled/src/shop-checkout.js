import{PolymerElement,html,Debouncer,timeOut}from"./shop-app.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="shop-checkbox">
  <template>
    <style>
...
</dom-module>`;document.head.appendChild($_documentContainer$1.content);class ShopCheckout extends PolymerElement{static get template(){return html`
