import{Base,Polymer,dom,flush,html$1 as html,afterNextRender,add,addListener,IronResizableBehavior,useShadow,PolymerElement,html as html$1,mixinBehaviors,Debouncer,timeOut,microTask,IronSelectableBehavior}from"./shop-app.js";Polymer({_template:html`
    <style>
      :host {
        position: fixed;
        top: -120px;
...
</dom-module>`;document.head.appendChild($_documentContainer.content);const template$3=html`
...
`;template$3.setAttribute("strip-whitespace","");Polymer({_template:template$3,is:"paper-spinner-lite",behaviors:[PaperSpinnerBehavior]});const $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<iron-iconset-svg style="display:none" name="icons" size="24">
<svg><defs>
